...
module.exports.factory = function (router, repo, exceptions, Cart, usersRepo, Orderhistory) {
    ...
    //First, find the book in database
    //Then, check whether it is user or guest. If it is guest, use session. Else, get the user from databse and
    //add the book to user's cart
    ...
    //First, find the book in database
    //Then, check whether it is user or guest. If it is guest, use session. Else, get the user from databse and
    //delete the book to user's cart
    ...
    //First, check whether it is user or guest. If it is guest, use session. Else, get the user from databse and
    ...
    //The main function of this is to get the user from the database and send it back to controller on client side
