...
Hilary.scope('heinz').register({
    ...
    factory: function ($this, GidgetRoute, locale, viewEngine, $, Books, Book, CartVM) {
        'use strict';
        //Use ajax to send request to controller on server side to buy a book
        //When get response, it will be replaced with '/cart'
        ...
        //Use ajax to send request to controller on server side to add the amount of a book
        //When get response, it will change the number in cart
        ...
        //Use ajax to send request to controller on server side to delete a book
        //When get response, it will be replaced with '/cart'
        ...
        //When get response, it will be replaced with cart page and CartVM data.
